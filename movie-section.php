...
<html lang="en" dir="ltr">
  ...
  <section id="videosec">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      $sql= "SELECT * FROM trailer WHERE avatar='movie1.jpg'";
      $result = $conn->query($sql);
      if ($result->num_rows > 0) {
      ...
      $sql= "SELECT * FROM trailer WHERE avatar='movie2.jpg'";
      $result = $conn->query($sql);
      if ($result->num_rows > 0) {
      ...
      $sql= "SELECT * FROM trailer WHERE avatar='movie3.jpg'";
      $result = $conn->query($sql);
      if ($result->num_rows > 0) {
      ...
      $sql= "SELECT * FROM trailer WHERE avatar='movie4.jpg'";
      $result = $conn->query($sql);
      if ($result->num_rows > 0) {
