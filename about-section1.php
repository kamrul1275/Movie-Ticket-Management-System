...
<div class="row ">
  ...
  <div class="col-md-6">
    <br>
    <img class="image_logo"src="photo/kash.jpg" alt="" height="330px" width="480px">
  </div>
  <div class="col-md-3">
      ...
      <div class="row">
        <div class="col-md-12 ">
          ...
          <p class="font-italic display-5">Design by</p>
          <p class="lead font-weight-bold">Tanvir & Kashfi</p>
            ...
            <p class="lead">Copyright © chayachobi</p>
<!--
          <!--button-->
                   ...
                   <div class="modal-dialog">
                     <div class="modal-content">
                       ...
                       <div class="form-group">
                         <input type="text" name="" value="" placeholder="Your Feedback" class="form-control">
                       </div>
