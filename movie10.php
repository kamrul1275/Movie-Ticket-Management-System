<li class="list-inline-item">
  <div class="card">
      <div class="imgBx">
        <a href="#"><img  src="avatar/trending/<?php echo $row["avatar"]; ?>" alt="" class="explore-image image10" height="230px" width="240px"></a>
      </div>


  <div class="pt-2 mb-3 text-center">
     <div class="contentBx">
       <a href="#" class=" buy" data-toggle="modal" data-target="#details-10">Details</a >
       <a href="#" class=" buy" data-toggle="modal" data-target="#booking-10">Book Now!</a >
     </div>

    <div class="modal" id="details-10">
       ...
       <div class="modal-content">
         ...
         <div class="modal-body text-left">
           ...
           if ($row["3D"]=='') {
             ...
             <?php
             echo "3D: Tk "; echo $row["3dprice"]; echo "<br>"; ?>
